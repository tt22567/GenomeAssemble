...
# load libraries
from Bio import SeqIO #Biopython加载模块
...
if __name__ == "__main__":
    ...
    parser.add_argument('--valid', '-v',
                        type=str,
                        help='Classification validation of each contig by DIAMOND blastx and "nr" database. If specified by a NCBI-standard taxon class (e.g. phylum, family, etc., case-insensitive), the --csv flag should be specified with the output of Diamond.',
                        default="")
