...
DIR_trans=/user/work/tt22567/Neuroptera/4_trifasta/out_dowFaa #in_FAA,out_Faa,out_dowFaa
...
#intrans,outrans
DIR_output=./DIR_Busco_outdowfaa
log_file=busco_outdowfaa.log 
csv_file=summarizeBusco_outdowfaa.csv
...
for i in $DIR_trans/*_protein.faa;do
