...
DIR_trans=/user/work/tt22567/Neuroptera/4_trifasta/1_inRnaTri  #1_inRnaTri, 3_outRnaTri
...
DIR_output1=./DIR_infaa  #DIR_infaa_intrans, DIR_outfaa_intrans
DIR_output2=./DIR_Busco_intrans  #DIR_Busco_intrans, DIR_Busco_outrans
DIR_logfile=./DIR_log
...
#Intrans,Outrans
log_file1=Intrans_L.pep.cdhit.log
log_file2=Intrans_Busco.log
csv_file=summarizeBusco_intrans.csv
