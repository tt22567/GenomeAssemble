...
PWD=/user/work/tt22567/Neuroptera/4_trifasta/out_Fasta #1_inRnaTri,3_outRnaTri,in_Fasta;out_Fasta
DIR_seqkit=/user/work/tt22567/Miniconda3/ENTER/envs/Lacewings/bin

target_group=outRnaDXTri  #inRnaTri,outRnaTri,inRnaDXTri;outRnaDXTri
target_seq=trinity.Trinity.Sifted.DeContX.fasta  #trinity.Trinity.fasta； trinity.Trinity.Sifted.DeContX.fasta
